...
export const Content = ({ title, text, image, target }) => {
  return (
    <div className=" flex flex-col lg:flex-row-reverse space-y-16 lg:space-y-0 text-center lg:text-left container xl:max-w-7xl mx-auto px-4 py-4 lg:px-8 lg:py-12">
      <div className=" h-1/6 lg:w-1/2 lg:mr-4 lg:flex lg:justify-center lg:items-center">
